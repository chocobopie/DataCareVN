                          ...
                          child: Theme(
                            ...
                            child: ExpansionTile(
                              ...
                              children: <Widget>[
                                ...
                                CustomListTile(listTileLabel: 'Bảo hiểm cá nhân', alertDialogLabel: 'Cập nhật bảo hiểm cá nhân', numberEditController: personalInsuranceController, value: personalInsuranceController.text.isEmpty ? _payroll!.personalInsurance.toString() : personalInsuranceController.text, readOnly: _readOnlyPayroll,),
                                ...
                                ListTile(
                                  title: const Text('Tổng tiền', style: TextStyle(color: Colors.red, fontWeight: FontWeight.w600,),),
                                  trailing: Text( '${moneyFormat(_payroll!.total.toString())}đ', style: const TextStyle(color: Colors.red, fontWeight: FontWeight.w600,),),
                                ),
