...
class HrPersonalCommissionDetail extends StatefulWidget {
  const HrPersonalCommissionDetail({Key? key, required this.personalCommission}) : super(key: key);

  final PersonalCommission personalCommission;

  @override
  State<HrPersonalCommissionDetail> createState() => _HrPersonalCommissionDetailState();
}

class _HrPersonalCommissionDetailState extends State<HrPersonalCommissionDetail> {
                              ...
                              children: [
                                Expanded(
                                  child: CustomTextButton(
                                    ...
                                    onPressed: () async {
                                      showLoaderDialog(context);
                                      bool result = await _deleteAPersonalCommission();
                                      if(result == true){
                                        Navigator.pop(context);
                                        ScaffoldMessenger.of(context).showSnackBar(
                                          const SnackBar(content: Text('Xóa quy định tiền thưởng cá nhân thành công')),
                                        );
                                        Navigator.pop(context);
                                      }else{
                                        Navigator.pop(context);
                                        ScaffoldMessenger.of(context).showSnackBar(
                                          const SnackBar(content: Text('Xóa quy định tiền thưởng cá nhân thất bại')),
                                        );
                                      }
                                    },
                                  ),
  ...
  Future<bool> _deleteAPersonalCommission() async {

    bool result = await CommissionViewModel().deleteAPersonalPermission(widget.personalCommission.personalCommissionId);
