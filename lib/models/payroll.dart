...
class Payroll {
  ...
  int parkingFee;
  int fine;
  int personalInsurance;
  int companyInsurance;
  int actualSalaryReceived;
  int newSignPersonalSalesBonus;
  int renewedPersonalSalesBonus;
  int managementSalesBonus;
  int supporterSalesBonus;
  int clB20SalesBonus;
  int contentManagerFanpageTechnicalEmployeeBonus;
  int collaboratorFanpageTechnicalEmployeeBonus;
  int renewedFanpageTechnicalEmployeeBonus;
  int contentManagerWebsiteAdsTechnicalEmployeeBonus;
  int collaboratorWebsiteTechnicalEmployeeBonus;
  int renewedWebsiteTechnicalEmployeeBonus;
  int collaboratorAdsTechnicalEmployeeBonus;
  int lecturerEducationTechnicalEmployeeBonus;
  int tutorEducationTechnicalEmployeeBonus;
  int techcareEducationTechnicalEmployeeBonus;
  int emulationBonus;
